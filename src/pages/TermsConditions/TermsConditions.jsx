    ...
    <div className="terms-container">
      <div className="terms-content">
        ...
        <section className="terms-section">
          ...
          <p className="terms-text">
            The following organizations may link to our website after the
            written approval:
          </p>
          <ul className="terms-list">
        ...
        <section className="terms-section">
          <h2 className="terms-section-title">5. iFrames</h2>
          <p className="terms-text">
        ...
        <section className="terms-section">
          <h2 className="terms-section-title">6. Content Liability</h2>
          <p className="terms-text">
        ...
        <section className="terms-section">
          <h2 className="terms-section-title">7. Your Privacy</h2>
          <p className="terms-text">Please read Privacy Policy</p>
        </section>

        <section className="terms-section">
          <h2 className="terms-section-title">8. Reservation of Rights</h2>
          <p className="terms-text">
        ...
        <section className="terms-section">
          <h2 className="terms-section-title">10. Disclaimer</h2>
          <p className="terms-text">
